"""
인기있는 arXiv 논문 PDF 링크를 생성하는 스크립트
"""

# 인기있는 arXiv 논문 ID들 (다양한 분야의 유명한 논문들)
popular_arxiv_papers = [
    ...
    "1905.02244",  # EfficientNet: Rethinking Model Scaling for Convolutional Neural Networks
    "2104.00298",  # MicroNet: Improving Image Recognition with Extremely Low FLOPs
]

# 파일에 PDF URL 작성
with open("arxiv_top1000_links.txt", "w") as f:
    for i, paper_id in enumerate(popular_arxiv_papers, 1):
